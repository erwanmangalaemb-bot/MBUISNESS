          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col items-center gap-3 mb-8">
                <svg width="60" height="50" viewBox="0 0 120 100" fill="none" className="float">
                ...
                >
                  <span className="gradient-text">M</span>Buisness
                </span>
              </div>

              <p className="text-sm italic leading-relaxed max-w-xs mx-auto mb-8" style={{ color: 'var(--muted-2)' }}>
